package com.num3rd.mapreduce.demo.common.compress.parquet;
...
public class WordCount {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // new method setCompression() iml ParquetOutputFormat
        AvroParquetOutputFormat.setCompression(job, CompressionCodecName.UNCOMPRESSED);
        ...
        //AvroParquetOutputFormat.setOutputCompressorClass(job, CompressionCodec.class);
